...
REFERRAL_PAYOUT_UAH = 50
# Історична назва змінної збережена для сумісності, але тепер це
# фіксована винагорода за 1 оплаченого реферала, а не відсоток.
REFERRAL_PAYOUT_RATE = 50.0
