...
Telegram-бот для пошуку нерухомості без комісії: оренда квартир, будинків, кімнат і офісів. Купівля квартир і будинків тимчасово показується як розділ "в розробці", але внутрішні категорії збережені в коді.
...
- `Купівля` - тимчасово показує статус "в розробці"; внутрішні категорії купівлі збережені в коді для швидкого повернення.
