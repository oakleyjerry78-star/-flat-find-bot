...
OLX_INDEXER_MAX_PAGES=1
OLX_INDEXER_CITY_PAUSE_SECONDS=1.5
OLX_INDEXER_MIN_REFRESH_SECONDS=300
OLX_INDEXER_HOT_TTL_SECONDS=7200
OLX_STALE_AFTER_SECONDS=86400
OLX_PURGE_AFTER_SECONDS=604800
```

Коли користувач шукає конкретне місто і тип житла, цей пошук одразу потрапляє в пріоритетну чергу індексатора. Старі оголошення, які давно не оновлювались, стають неактивними й більше не показуються; дуже старі неактивні записи очищаються з бази.
